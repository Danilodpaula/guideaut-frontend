import { Dialog, DialogDescription, DialogOverlay, DialogPortal, DialogTrigger, DialogClose, DialogContent, DialogTitle } from "@/components/ui/dialog";
import { Language } from "../i18n/language.i18n";
import { Select, SelectItem, SelectContent, SelectTrigger, SelectValue } from "@/components/ui/select";
import { InputsForm, Watch } from "../hooks/usePersonaAutForm";
                ...
                <DialogContent>
                    ...
                    {language === Language.Portuguese
                        ...
                        : (
                            <div className="flex flex-col">
                                <p>
                                    <strong>- Demographic characteristics:</strong> used in traditional models,
                                    consisting of name, age, gender, and photo.
                                </p>
                                <p>
                                    <strong>- General characteristics:</strong> consists of general information
                                    about the autism level and type of language.
                                </p>
                                <p>
                                    <strong>- Calming activities:</strong> a list of activities or situations that
                                    help the autistic person feel calm.
                                </p>
                                <p>
                                    <strong>- Stressful activities:</strong> a list of activities or situations
                                    that make the autistic person feel stressed.
                                </p>
                                <p>
                                    <strong>- Social and family aspects:</strong> describes the autistic person's
                                    relationship with parents, other family members, therapists, schoolmates, and
                                    other social aspects.
                                </p>
                                <p>
                                    <strong>- Technological software aspects:</strong> describes the autistic
                                    person's relationship with technologies and their affinities.
                                </p>
                                <p>
                                    <strong>- Stereotypies and habits:</strong> used to describe habits and
                                    stereotyped behaviors of the autistic person.
                                </p>
                            </div>
                    ...
                    {language === Language.Portuguese
                        ...
                        : (
                            <div className="flex flex-col">
                                ...
                                <p>
                                    <strong>- About:</strong> used to condense the persona’s information in a
                                    more flexible, story-like format.
                                </p>
                            </div>
...
const PersonaAutChooseModel = ({ language, control, setModel, model }: Props) => {
    return (
                ...
                render={({ field: { onChange, value } }) => {
                    ...
                    return (
                        <Select onValueChange={changeFunction} value={value}>
                            <SelectTrigger>
                                <SelectValue placeholder={language === Language.Portuguese
                                    ? "Escolha o modelo"
                                    : "Choose the model"
                                } />
                            </SelectTrigger>
                            <SelectContent>
                                <SelectItem value="1">{language === Language.Portuguese
                                    ? "Modelo 1"
                                    : "Model 1"
                                }</SelectItem>
                                <SelectItem value="2">{language === Language.Portuguese
                                    ? "Modelo 2"
                                    : "Model 2"
                                }</SelectItem>
                            </SelectContent>
