...
import { genders } from "../i18n/shared/genders";
import { languages } from "../i18n/shared/languages";
import { PersonaAutStepProps } from "../types/personaAut.props.type";
import VGA from "./VGA";

const PersonaAutConfirmation = ({ language, watch }: PersonaAutStepProps & { watch: Watch }) => {
