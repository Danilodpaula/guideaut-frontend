...
import { defaultStressfulActivities } from "../i18n/personaAut.i18n";

const PersonaAutStressfulActivities = ({ language, control }: PersonaAutStepProps) => {
...
export default PersonaAutStressfulActivities;