...
import { languages } from "../../i18n/shared/languages";
                ...
                <DialogContent >
                    ...
                    {language === Language.Portuguese
                        ...
                        : (
                            <div className="flex flex-col">
                                <p>
                                    <strong>- Nonverbal:</strong> difficulty expressing themselves verbally or
                                    orally, possibly not developing spoken language or having limited speech.
                                    Communicates through gestures or facial expressions.
                                </p>
                                <p>
                                    <strong>- Verbal:</strong> uses verbal communication but with certain
                                    peculiarities, including a tendency to be literal and difficulty
                                    understanding metaphors and sarcasm.
                                </p>
                                <p>
                                    <strong>- Echolalic Verbal:</strong> repetition of phrases or words heard
                                    from other people or external sources (TV, music, etc.), either in or out
                                    of the context of a conversation.
                                </p>
                            </div>
                ...
                render={({ field: { onChange, value } }) => (
                    <Select onValueChange={onChange} value={value}>
                        ...
                        <SelectContent>
                            {languages.map((lang) => {
                                return (
                                    <SelectItem key={lang.id} value={lang.id}>{language === Language.Portuguese
                                        ? lang.pt
                                        : lang.en
                                    }</SelectItem>
                                );
