  ...
  const phases = [
    {
      ...
      activities: [
        ...
        {
          name: language === "pt-BR" ? "Consolidar Dados" : "Consolidate Data",
          description:
            language === "pt-BR"
    ...
    },
    {
      ...
      activities: [
        {
          name: language === "pt-BR" ? "Triangular Dados" : "Triangulate Data",
          description:
            language === "pt-BR"
        ...
        {
          name: language === "pt-BR" ? "Gerar PersonAut" : "Generate PersonAut",
          description:
            language === "pt-BR"
    ...
    },
    {
      ...
      artifacts: [
        ...
        language === "pt-BR" ? "Feedback de Validação" : "Validation Feedback",
      ],
    },
  ];
        ...
        <CardContent className="space-y-4">
          ...
          <div className="flex gap-2">
            <Badge variant="outline">
              {language === "pt-BR" ? "Design Thinking" : "Design Thinking"}
            </Badge>
            <Badge variant="outline">
              {language === "pt-BR"
