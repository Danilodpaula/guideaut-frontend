...
export default function Roles() {
  ...
  const availablePermissions: Permission[] = [
    { id: "users.view", name: language === "pt-BR" ? "Visualizar usuários" : "View users", description: language === "pt-BR" ? "Ver lista de usuários" : "View user list" },
    { id: "users.create", name: language === "pt-BR" ? "Criar usuários" : "Create users", description: language === "pt-BR" ? "Adicionar novos usuários" : "Add new users" },
    { id: "users.edit", name: language === "pt-BR" ? "Editar usuários" : "Edit users", description: language === "pt-BR" ? "Modificar dados de usuários" : "Modify user data" },
    { id: "users.delete", name: language === "pt-BR" ? "Excluir usuários" : "Delete users", description: language === "pt-BR" ? "Remover usuários do sistema" : "Remove users from system" },
    { id: "roles.manage", name: language === "pt-BR" ? "Gerenciar papéis" : "Manage roles", description: language === "pt-BR" ? "Criar e editar papéis" : "Create and edit roles" },
    { id: "categories.manage", name: language === "pt-BR" ? "Gerenciar categorias" : "Manage categories", description: language === "pt-BR" ? "CRUD de categorias" : "Category CRUD" },
    { id: "audit.view", name: language === "pt-BR" ? "Ver auditoria" : "View audit", description: language === "pt-BR" ? "Acessar logs do sistema" : "Access system logs" },
    { id: "import.data", name: language === "pt-BR" ? "Importar dados" : "Import data", description: language === "pt-BR" ? "Upload em lote" : "Bulk upload" },
  ];

  // 🧩 Papéis simulados
  const [roles, setRoles] = useState<Role[]>([
    { id: "1", name: "ADMIN", permissions: availablePermissions.map(p => p.id), userCount: 2 },
    { id: "2", name: "USER", permissions: ["users.view"], userCount: 245 },
    { id: "3", name: "MODERATOR", permissions: ["users.view", "users.edit", "categories.manage"], userCount: 8 },
  ]);
            ...
            <div className="space-y-4 py-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  placeholder={language === "pt-BR" ? "Ex: MODERATOR" : "e.g. MODERATOR"}
                />
              </div>
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>{language === "pt-BR" ? "Usuários" : "Users"}</TableHead>
                  ...
                  <TableCell>
                    <div className="flex flex-wrap gap-1">
                      {role.permissions.slice(0, 3).map(permId => (
                        ...
                        >
                          {availablePermissions.find(p => p.id === permId)?.name.split(" ")[0]}
                        </span>
                      ))}
