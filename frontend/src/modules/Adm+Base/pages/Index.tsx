...
const Index = () => {
  ...
  const stats = [
    ...
    { title: t("nav.categories"), value: "32", icon: FolderTree, change: "+5%" },
        ...
        <Card className="bg-gradient-to-r from-primary/10 to-accent/10 border-primary/20">
          <CardContent className="p-6">
            ...
            <p className="text-muted-foreground mb-4">
              Você está navegando como visitante. Explore livremente o conteúdo público da plataforma.
              Para postar recomendações e acessar recursos exclusivos, faça login ou cadastre-se.
            </p>
          </CardContent>
        </Card>
      )}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="text-muted-foreground leading-relaxed">
            ...
            <strong>ProAut</strong>, um processo para apoiar o desenvolvimento de
            interfaces de aplicativos para pessoas autistas. Contém propriedades
            de sistema colaborativo, recomendações de design para interfaces
            gráficas mais acessíveis e inclusivas, bem como características
            específicas de perfis autistas para promover empatia entre autistas
            e equipes de desenvolvimento — utilizando artefatos e padrões
            definidos pelo ProAut.
          </p>
