...
export default function PrototypingPhase() {
  ...
  const phaseDeliverables = [
    ...
    { id: 'cta', name_pt: "Canvas dos Terapeutas de Autistas (CTA)", name_en: "Autistic Therapists Canvas (ATC)" },
    { id: 'css', name_pt: "Canvas do Solicitante do Software (CSS)", name_en: "Software Requester Canvas (RSC)" },
    { id: 'fca', name_pt: "Formulário de Caracterização do Autista (FCA)", name_en: "Autistic Characterization Form" },
    { id: 'vga', name_pt: "Gráfico de Visão Geral do Autista (VGA)", name_en: "Autistic Overview Graph (AOG)" },
  ];
  ...
  const tableOfContents = [
    ...
    { 
      ...
      title: language === "pt-BR" ? "Aprender sobre o contexto" : "Learn about the context",
      type: 'scroll',
    },
    { 
      id: 'extrair-requisitos', 
      title: language === "pt-BR" ? "Extrair requisitos" : "Extract requirements",
      type: 'scroll',
    },
    { 
      id: 'consolidar-dados', 
    ...
    <div className="flex gap-6">
      ...
      <div className="flex-1 space-y-6 p-6 animate-fade-in">
        ...
        <section id="visao-geral" className="scroll-m-20 space-y-6">
          ...
          <div className="space-y-4 text-lg">
            ...
            <ul className="space-y-3 list-disc list-inside mb-4 ml-4">
              <li><strong>{language === "pt-BR" ? "Entrada da fase:" : "Phase input:"}</strong> {language === "pt-BR" ? "a ideia ou visão geral de aplicação." : "the application idea or overview."}</li>
              <li><strong>{language === "pt-BR" ? "Saída da fase:" : "Phase output:"}</strong> {language === "pt-BR" ? "CCA (Canvas dos Cuidadores de Autistas); CTA (Canvas dos Terapeutas de Autistas); CSS (Canvas do Solicitante do Software); Formulário de Caracterização do Autista; e VGA (Gráfico de Visão Geral do Autista)." : "ACC (Autistic Caregivers Canvas); ATC (Autistic Therapists Canvas); RSC (Software Requester Canvas); Autistic Characterization Form; and AOG (Autistic Overview Graph)."}</li>
              <li><strong>{language === "pt-BR" ? "Envolvidos:" : "Involved:"}</strong> {language === "pt-BR" ? "Pais, especialistas, solicitantes de software, designers/desenvolvedores." : "Parents, specialists, software requesters, designers/developers."}</li>
              <li><strong>{language === "pt-BR" ? "Atividades da Fase:" : "Phase Activities:"}</strong> {language === "pt-BR" ? "Aprender sobre o contexto, Elicitar Requisitos e Consolidar Dados." : "Learn about the context, Elicit Requirements and Consolidate Data."}</li>
            </ul>
            ...
            <div className="mt-8">
              <h3 className="text-xl font-semibold mb-4">
                {language === "pt-BR" ? "Artefatos Gerados" : "Generated Artifacts"}
              </h3>
              <ul className="grid gap-2">
                {phaseDeliverables.map((artifact) => (
                  <li key={artifact.id} className="flex items-center gap-2 text-muted-foreground">
                    <ChevronRight className="h-4 w-4 text-blue-500" />
                    <span>{language === "pt-BR" ? artifact.name_pt : artifact.name_en}</span>
                  </li>
                ))}
              </ul>
            </div>
        ...
        <section id="aprender-contexto" className="scroll-m-20 space-y-6 mt-12">
          <h2 className="text-2xl font-bold tracking-tight border-b pb-2">
            {language === "pt-BR" ? "Aprender sobre o contexto" : "Learn about the context"}
          </h2>
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">
                {language === "pt-BR" ? "Elaboração dos itens de busca" : "Search items elaboration"}
              </h3>
              <p>
                {language === "pt-BR"
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <h4 className="font-semibold text-blue-800 mb-2">
                  {language === "pt-BR" ? "Contexto exemplo:" : "Example context:"}
                </h4>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">
                {language === "pt-BR" ? "Definição das fontes de busca" : "Definition of search sources"}
              </h3>
              <p>
                {language === "pt-BR"
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">
                {language === "pt-BR" ? "Realizar pesquisa Desk" : "Perform Desk Research"}
              </h3>
              <p>
                {language === "pt-BR"
        ...
        <section id="extrair-requisitos" className="scroll-m-20 space-y-6 mt-12">
          <h2 className="text-2xl font-bold tracking-tight border-b pb-2">
          ...
          <div className="space-y-8">
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">
                {language === "pt-BR" ? "Caracterização do autista" : "Autistic characterization"}
              </h3>
              <p>
                {language === "pt-BR"
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h4 className="font-semibold text-yellow-800 mb-2">
                  {language === "pt-BR" ? "Sugestão de Procedimento para preenchimento do FCA:" : "Suggested Procedure for FCA completion:"}
                </h4>
                <ol className="text-yellow-700 list-decimal list-inside space-y-2 ml-4">
                  <li>{language === "pt-BR" ? "Imprima o FCA (caso não seja possível aplicar por meio eletrônico);" : "Print the FCA (if it's not possible to apply electronically);"}</li>
                  <li>{language === "pt-BR" ? "Antes de iniciar a entrevista com os clientes/pais/mães/responsáveis, fale sobre a necessidade de preencher o FCA ressaltando o que ele significa e qual a sua importância para o desenvolvimento da tecnologia;" : "Before starting the interview with clients/parents/guardians, talk about the need to complete the FCA emphasizing what it means and its importance for technology development;"}</li>
                  <li>{language === "pt-BR" ? "Defina se o FCA será aplicado antes ou depois da entrevista;" : "Define whether the FCA will be applied before or after the interview;"}</li>
                  <li>{language === "pt-BR" ? "Iniciar a aplicação do FCA marcando para cada item de característica, o valor 1 caso a característica esteja presente na criança ou 0 no caso de ausência;" : "Start the FCA application by marking for each characteristic item, value 1 if the characteristic is present in the child or 0 in case of absence;"}</li>
                </ol>
              </div>
            </div>
            ...
            <div className="space-y-4">
                ...
                <div className="border rounded-lg p-4">
                  <div className="mb-4">
                    <img 
                      ...
                      alt={language === "pt-BR" ? "Roteiro de Perguntas para Cliente" : "Questionnaire for Client"}
                      className="w-full h-auto rounded-md shadow-sm"
                    />
                  </div>
                  <h5 className="font-semibold text-lg mb-2">
                    {language === "pt-BR" ? "Roteiro para Cliente" : "Questionnaire for Client"}
                  </h5>
                ...
                <div className="border rounded-lg p-4">
                  <div className="mb-4">
                    <img 
                      ...
                      alt={language === "pt-BR" ? "Roteiro de Perguntas para Cuidador" : "Questionnaire for Caregiver"}
                      className="w-full h-auto rounded-md shadow-sm"
                    />
                  </div>
                  <h5 className="font-semibold text-lg mb-2">
                    {language === "pt-BR" ? "Roteiro para Cuidador" : "Questionnaire for Caregiver"}
                  </h5>
                  <p className="text-sm text-muted-foreground">
                    {language === "pt-BR"
                ...
                <div className="border rounded-lg p-4">
                  <div className="mb-4">
                    <img 
                      ...
                      alt={language === "pt-BR" ? "Roteiro de Perguntas para Terapeuta" : "Questionnaire for Therapist"}
                      className="w-full h-auto rounded-md shadow-sm"
                    />
                  </div>
                  <h5 className="font-semibold text-lg mb-2">
                    {language === "pt-BR" ? "Roteiro para Terapeuta" : "Questionnaire for Therapist"}
                  </h5>
                  <p className="text-sm text-muted-foreground">
                    {language === "pt-BR"
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                <h4 className="font-semibold text-yellow-800 mb-2">
                  {language === "pt-BR" ? "Sugestão de Procedimento para entrevista:" : "Suggested Procedure for interview:"}
                </h4>
                <ol className="text-yellow-700 list-decimal list-inside space-y-2 ml-4">
                  <li>{language === "pt-BR" ? "Agende com o entrevistado;" : "Schedule with the interviewee;"}</li>
                  <li>{language === "pt-BR" ? "Somente para os especialistas, a seleção do entrevistado deve ser feita de acordo com a área de atuação em relação ao objetivo e necessidades do software;" : "Only for specialists, the interviewee selection should be made according to the field of work in relation to the software's objective and needs;"}</li>
                  <li>{language === "pt-BR" ? "Defina o meio para registrar a entrevista (gravação de áudio, bloco de anotações, filmagem etc.);" : "Define the means to record the interview (audio recording, notepad, filming etc.);"}</li>
                  <li>{language === "pt-BR" ? "Providencie o material para o registro da entrevista;" : "Provide the material for interview recording;"}</li>
                  <li>{language === "pt-BR" ? "Chegue com antecedência ao local da entrevista;" : "Arrive early to the interview location;"}</li>
                  <li>{language === "pt-BR" ? "Exceto para o solicitante, explique os objetivos e necessidades do software bem como a finalidade da entrevista, apresente o TCLE (Termo de Consentimento Livre e Esclarecido) e solicite sua assinatura (ou concordância para o caso virtual);" : "Except for the requester, explain the software's objectives and needs as well as the interview purpose, present the TCLE (Free and Informed Consent Form) and request their signature (or agreement for virtual cases);"}</li>
                  <li>{language === "pt-BR" ? "Também, exceto para o solicitante, explique sobre o preenchimento do FCA. Sendo que para o especialista, ele deverá responder com base na maioria dos atendimentos;" : "Also, except for the requester, explain about FCA completion. For the specialist, they should answer based on the majority of their cases;"}</li>
                  <li>{language === "pt-BR" ? "Antes de usar o roteiro proposto, pergunte e anote o nome do entrevistado;" : "Before using the proposed script, ask and note the interviewee's name;"}</li>
                  <li>{language === "pt-BR" ? "Inicie a entrevista usando o roteiro sugerido;" : "Start the interview using the suggested script;"}</li>
                </ol>
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-semibold">
                {language === "pt-BR" ? "Pesquisa Exploratória" : "Exploratory Research"}
              </h3>
              <p>
                {language === "pt-BR"
              ...
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <h4 className="font-semibold text-yellow-800 mb-2">
                  {language === "pt-BR" ? "Sugestão de Procedimento da Pesquisa Exploratória:" : "Suggested Procedure for Exploratory Research:"}
                </h4>
                <ol className="text-yellow-700 list-decimal list-inside space-y-2 ml-4">
                  <li>{language === "pt-BR" ? "Agende o procedimento com uma família/especialista/professor/escola, ou seja, o responsável pelo local onde será realizada a pesquisa exploratória;" : "Schedule the procedure with a family/specialist/teacher/school, that is, the person responsible for the location where the exploratory research will be conducted;"}</li>
                  <li>{language === "pt-BR" ? "Defina o meio para registrar a observação (gravação de áudio, bloco de anotações, filmagem etc.);" : "Define the means to record the observation (audio recording, notepad, filming etc.);"}</li>
                  <li>{language === "pt-BR" ? "Providencie o material para o registro da observação;" : "Provide the material for observation recording;"}</li>
                  <li>{language === "pt-BR" ? "Chegue com antecedência ao local;" : "Arrive early to the location;"}</li>
                  <li>{language === "pt-BR" ? "Registre as formas de interação e comportamento da criança no seu cotidiano;" : "Record the forms of interaction and behavior of the child in their daily life;"}</li>
                </ol>
              </div>
            </div>
          </div>
        ...
        <section id="consolidar-dados" className="scroll-m-20 space-y-6 mt-12">
          ...
          <ul className="space-y-2 list-disc list-inside mb-4 ml-4">
            <li><strong>CSS:</strong> {language === "pt-BR" ? "Canvas dos Solicitantes;" : "Software Requester Canvas;"}</li>
            <li><strong>CCA:</strong> {language === "pt-BR" ? "Canvas dos Cuidadores;" : "Caregivers Canvas;"}</li>
            <li><strong>CTA:</strong> {language === "pt-BR" ? "Canvas dos Terapeutas;" : "Therapists Canvas;"}</li>
          </ul>
            ...
            <div className="border rounded-lg p-4">
              <div className="mb-4">
                <img 
                  ...
                  alt={language === "pt-BR" ? "Canvas para entrevista do solicitante (CSS)" : "Canvas for requester interview (CSS)"}
                  className="w-full h-auto rounded-md shadow-sm"
                />
              </div>
              <h5 className="font-semibold text-lg mb-2">
                {language === "pt-BR" ? "Canvas do Solicitante (CSS)" : "Requester Canvas (CSS)"}
              </h5>
              <p className="text-sm text-muted-foreground">
                {language === "pt-BR"
            ...
            <div className="border rounded-lg p-4">
              <div className="mb-4">
                <img 
                  ...
                  alt={language === "pt-BR" ? "Canvas para entrevista do cuidador (CCA)" : "Canvas for caregiver interview (CCA)"}
                  className="w-full h-auto rounded-md shadow-sm"
                />
              </div>
              <h5 className="font-semibold text-lg mb-2">
                {language === "pt-BR" ? "Canvas do Cuidador (CCA)" : "Caregiver Canvas (CCA)"}
              </h5>
              <p className="text-sm text-muted-foreground">
                {language === "pt-BR"
            ...
            <div className="border rounded-lg p-4">
              <div className="mb-4">
                <img 
                  ...
                  alt={language === "pt-BR" ? "Canvas para entrevista do terapeuta (CCT)" : "Canvas for therapist interview (CCT)"}
                  className="w-full h-auto rounded-md shadow-sm"
                />
              </div>
              <h5 className="font-semibold text-lg mb-2">
                {language === "pt-BR" ? "Canvas do Terapeuta (CTA)" : "Therapist Canvas (CTA)"}
              </h5>
              <p className="text-sm text-muted-foreground">
                {language === "pt-BR"
          ...
          <div className="space-y-4 mt-6">
            <h3 className="text-xl font-semibold">
              {language === "pt-BR" ? "Processo de Filtragem e Consolidação" : "Filtering and Consolidation Process"}
            </h3>
            <p>
              {language === "pt-BR"
            ...
            <p>
              <strong>{language === "pt-BR" ? "Lembre-se" : "Remember"}</strong>: {language === "pt-BR" ? "a ideia principal para o canvas é ser específico e conciso." : "the main idea for the canvas is to be specific and concise."}
            </p>

            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h4 className="font-semibold text-blue-800 mb-2">
                {language === "pt-BR" ? "Resolução de Conflitos" : "Conflict Resolution"}
              </h4>
              <p className="text-blue-700">
                {language === "pt-BR"
              ...
              <p className="text-blue-700 mt-2">
                <strong>{language === "pt-BR" ? "Exemplo:" : "Example:"}</strong> {language === "pt-BR"
